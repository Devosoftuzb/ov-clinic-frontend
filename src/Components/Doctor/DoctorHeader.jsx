...
function DoctorHeader() {
    ...
    const isDoctor = location.pathname
            ...
            <div className='Kassa__header'>
                <div className='Kassa__header__wrapper'>
                    <nav>
                        ...
                        <NavLink to='/doctor' className={isDoctor === "/doctor" ? 'button__link' : ''} >
                        ...
                        <NavLink to='/doctor/history' className={isDoctor === "/doctor/history" ? "button__link" : ""}>
                        ...
                        <NavLink to='/doctor/day' className={isDoctor === "/doctor/day" ? "button__link" : ""}>
                        ...
                        <NavLink to='/doctor/inpatients' className={isDoctor === "/doctor/inpatients" ? "button__link" : ""}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                <path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM12 3c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm7 16H5V7h14v12z " fill='#fff' />
                            </svg>
                            <span>
                                Мои стационарные
                            </span>
