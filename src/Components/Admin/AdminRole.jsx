...
function AdminRole() {
  ...
  return (
    <div className='AdminRole'>
        <AdminHeader/>
        <div className='AdminWorker__main AdminRole__main'>
        <div className='AdminWorker__main__header'>
            ...
            <div className='Admin__main__table admin__role'>
            <table>
                <thead>
                  <tr >
                    <th className='Register__table__number admin__role__num'>
                      <h3>
                        #
                      </h3>
                    </th>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button onClick={editWorker} className='Admin__main__table__edit '>
                        <svg className='Admin__main__table__edit__svg admin__role__svg' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path  d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75zM21.41 6.34l-3.75-3.75l-2.53 2.54l3.75 3.75z"></path></svg>
                        </button>
                        <button onClick={deleteWorker} className='Admin__main__table__delete'>
                        <svg className='admin__role__svg' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path  d="M19 4h-3.5l-1-1h-5l-1 1H5v2h14M6 19a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7H6z"></path></svg>
                        </button>
                      </div>
                    </td>
                  </tr>          
