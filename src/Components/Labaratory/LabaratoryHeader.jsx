...
function LabaratoryHeader() {
    let location = useLocation().pathname
    
    return (
        <section className='labaratory_header'>
            <div className='Kassa__header'>
                <div className='Kassa__header__wrapper'>
                    <nav>
                        ...
                        <NavLink to='/labaratory/active' className={location === "/labaratory/active" ? 'button__link' : ''} >
                        ...
                        <NavLink to='/labaratory/history' className={location === "/labaratory/history" ? 'button__link' : ''}>
                        ...
                        <NavLink to='/labaratory/day' className={location === "/labaratory/day" ? 'button__link' : ''}>
...
export default LabaratoryHeader